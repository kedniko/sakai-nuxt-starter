  ...
  <div class="card">
    ...
    <Timeline :value="customEvents" align="alternate" class="customized-timeline">
      <template #marker="slotProps">
        <span class="align-items-center justify-content-center border-circle shadow-2 h-2rem w-2rem flex text-white z-1" :style="{ backgroundColor: slotProps.item.color }">
