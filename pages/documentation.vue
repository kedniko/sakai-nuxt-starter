  ...
  <div class="grid">
    <div class="col-12">
      <div class="card docs">
        ...
        <p>Click <a href="https://github.com/primefaces/sakai-nuxt" target="_blank" class="text-primary font-medium hover:underline">here</a> to visit the version of Nuxt</p>
        ...
        <div class="video-container">
          <iframe className="video" width="560" height="315" src="https://www.youtube.com/embed/AHeSjJFR3ZE" frameborder="0" allowfullscreen />
        </div>
