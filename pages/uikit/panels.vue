...
<template>
  <div class="grid">
      ...
      <div class="card">
        ...
        <Toolbar>
          <template #start>
            ...
            <i class="pi pi-bars mr-2 p-toolbar-separator" />
    ...
    <div class="col-12 md:col-6">
      ...
      <Card>
        <template #title>
          <div class="align-items-center justify-content-between mb-0 flex">
            <h5>Card</h5>
    ...
    <div class="col-12">
      <div class="card">
        <h5>Divider</h5>
        <div class="grid">
          <div class="align-items-center justify-content-center flex col-5">
            <div class="p-fluid">
              <div class="field">
    ...
    <div class="col-12">
      <div class="card">
        ...
        <Splitter style="height: 300px" class="mb-5">
          <SplitterPanel :size="30" :min-size="10" style="overflow: scroll">
