  ...
  <div class="grid">
    ...
    <div class="col-12 lg:col-6">
      <div class="card">
        ...
        <i v-badge="2" class="pi p-text-secondary pi-bell mr-4" style="font-size: 2rem" />
        <i v-badge.danger="'10+'" class="pi pi-calendar p-text-secondary mr-4" style="font-size: 2rem" />
        <i v-badge.danger class="pi p-text-secondary pi-envelope" style="font-size: 2rem" />
    ...
    <div class="col-12 lg:col-6">
      ...
      <div class="card">
        <h4>Chip</h4>
        <h5>Basic</h5>
        <div class="align-items-center flex-column flex sm:flex-row">
      ...
      <div class="card">
        <h4>Skeleton</h4>
        <div class="border-round surface-border border-1 p-4">
          <div class="mb-3 flex">
