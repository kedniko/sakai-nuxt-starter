  ...
  <div class="block-section">
    <div class="block-header">
      ...
      <div class="block-actions">
        ...
        <a v-tooltip.focus.bottom="{ value: 'Copied to clipboard' }" :tabindex="0" class="block-action-copy" @click="copyCode($event)"><i class="pi pi-copy" /></a>
      </div>
    </div>
    <div class="block-content">
      ...
      <div v-if="blockView === BlockView.CODE">
        <CodeHighlight class="surface-card m-0">
          {{ code }}
        </CodeHighlight>
      </div>
    </div>
